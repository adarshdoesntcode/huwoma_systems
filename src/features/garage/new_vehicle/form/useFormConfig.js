export const useFormConfig = (
  ...
  },
  {
    ...
    formItemProps: {
      ...register("engineCC", {
        ...
        validate: (value) => {
          if (value < 0) {
            return "Engine CC cannot be negative";
          }
        },
        onChange: () => {
  ...
  },
  {
    ...
    formItemProps: {
      ...
      autoComplete: "off",
      placeholder: "Official colour name",
      type: "text",
    },
    required: false,
  },
...

  {
    ...
    formItemClassName: `justify-start font-normal ${
      selectedTransmission ? "" : "text-muted-foreground"
    }`,
    required: true,
  },
  {
    ...
    errors: errors?.category,
    formItemClassName: `justify-start font-normal ${
      selectedDriveType ? "" : "text-muted-foreground"
    }`,
    required: true,
  },
  {
    ...
    formItemClassName: `justify-start font-normal ${
      selectedFuelType ? "" : "text-muted-foreground"
    }`,
    required: true,
  },
  {
