      ...
      <div className="grid gap-2 p-4 border shadow-sm rounded-xl sm:p-6 bg-background ">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Double check everything looks right before saving your changes
          </p>
        </div>
        ...
        <div className="flex items-center justify-between gap-2 mt-6">
          ...
          <Button form="edit-garage-vehicle-form" type="submit">
            Save Changes <CheckCheck className="w-4 h-4 ml-2" />
          </Button>
        </div>
      </div>
    </div>
