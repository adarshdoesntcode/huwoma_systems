...
import { useDeleteCarwashTransactionMutation } from "../carwash/carwashApiSlice";
import { useDeleteSimracingTransactionMutation } from "./simRacingApiSlice";

export const SimRacingBookingDataTable = ({ columns, data }) => {
...
function ConfirmDelete({ showDelete, setShowDelete, deleteId, setDeleteId }) {
  const [deleteSimracingTransaction, { isLoading }] =
  ...
  const handleDelete = async () => {
    try {
      if (!deleteId) return;
      const res = await deleteSimracingTransaction({
        id: deleteId,
      });
